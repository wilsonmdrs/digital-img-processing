...
/**
 * Noise Reduction is a filter that apply on an image a calculation to reduce the imperfetions
 */
        ...
        if (!!context) {
            ...
            for (let x = 0; x < width; x++) {
                for (let y = 0; y < height; y++) {
                    ...
                    // Left Top Corner
                    if (x === 0 && y === 0) {
                        d4 =  Functions.getColorIndicesForCoord(x + 1,y + 1,width)
                    ...
                    // Right Top Corner
                        ...
                        d1 =  Functions.getColorIndicesForCoord(x - 1,y - 1,width)
                    ...
                    // Left Bottom Corner
                        ...
                        d2 =  Functions.getColorIndicesForCoord(x + 1,y - 1,width)
                    ...
                    // Right Bottom Corner 
                        ...
                        d3 =  Functions.getColorIndicesForCoord(x - 1,y + 1,width)
        ...
        if (!!context) {
            ...
            for (let x = 0; x < width; x++) {
                for (let y = 0; y < height; y++) {
                    ...
                    // Left Top Corner
                    if (x === 0 && y === 0) {
                        lr =  Functions.getColorIndicesForCoord(x + 1,y ,width)
                        lb =  Functions.getColorIndicesForCoord(x,y + 1 ,width)
                    ...
                    // Right Top Corner
                        ...
                        lt =  Functions.getColorIndicesForCoord(x,y - 1,width)
                        ll =  Functions.getColorIndicesForCoord(x - 1,y,width)
